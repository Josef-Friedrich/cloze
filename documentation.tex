...
\noindent
I am someone who loves \clozefil{to write cloze worksheets in \TeX}.
...
\mintinline{latex}{\def\clozeparcapture#1\par{...}}.
...
\TmpSecRef{sec:command-clozepar} and the macro version \cmd{\clozeparcapture}
\TmpSecRef{sec:command-clozeparcapture}.
