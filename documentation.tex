...
%-----------------------------------------------------------------------
% distance of the cloze line
%-----------------------------------------------------------------------

\subsection{distance of the cloze line}
...
\begin{lstlisting}
\setcloze{distance=0pt}
\end{lstlisting}

\setcloze{distance=0pt,thickness=0.4pt}
