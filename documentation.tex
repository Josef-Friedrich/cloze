...
If you want to imitate a hand-filled worksheet, then some fonts
are suitable for this purpose. This section is intended to provide
...
\emph{Kalam} for my worksheets.

\TmpHandwriting{Annie Use Your Telescope}
\TmpHandwriting{Architects Daughter}
\TmpHandwriting{Bad Script}
\TmpHandwriting{Caveat}
\TmpHandwriting{Cedarville-Cursive}
\TmpHandwriting{Coming Soon}
\TmpHandwriting{Give You Glory}
\TmpHandwriting{Gochi Hand}
\TmpHandwriting{Handlee}
\TmpHandwriting{Homemade Apple}
\TmpHandwriting{Indie Flower}
\TmpHandwriting{Just Another Hand}
\TmpHandwriting{Just Me Again Down Here}
\TmpHandwriting{Kalam}
\TmpHandwriting{Kristi}
\TmpHandwriting{La Belle Aurore}
\TmpHandwriting{Marck Script}
\TmpHandwriting{Neucha}
\TmpHandwriting{Nothing You Could Do}
\TmpHandwriting{Patrick Hand}
\TmpHandwriting{Reenie Beanie}
\TmpHandwriting{Seaweed Script}
\TmpHandwriting{Shadows Into Light}
\TmpHandwriting{Swanky and Moo Moo}
