...
\tt{log} &
\TmpDescriptionLine{Set the log level.} &
\TmpSecRef{sec:option-log} \\
...
\subsubsection{\tt{log}}
\label{sec:option-log}

The |log| option defines the log level for the Lua code. The following
