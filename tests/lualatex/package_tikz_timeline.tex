...
\begin{tikzpicture}[
  scale=0.7,
  transform shape,
  text box/.style={black, text width=3cm, align=left, draw},
  ...
  \yearArrowLabel(1946,1,2,
    U.S. Supreme court bans segregation on \cloze{Public Transit} (i.e. subways). 1946,left)

  \yearArrowLabel(1955,-1,3,
    Rosa \cloze{Parks} refuses to give up her seat on a \cloze{bus} in \cloze{Alabama} 1955,left)
  ...
  \yearArrowLabel(1968,-3,2,
    Martin Luther King Jr. is \cloze{assassinated} 1968,right)
\end{tikzpicture}
